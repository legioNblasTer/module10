...
################################################################################
    ...
    def test_required_fields(self):
        ...
        for i in range(len(json_response)):
            key_list = list(json_response[i].keys())
            for j in range(len(key_list)):
                self.assertEqual(key_list[j],required_fields[j])
...
################################################################################
    ...
    def test_escalators(self):
        ...
        for i in range(len(json_response)):
            self.assertEqual(json_response[i].get("UnitType"), "ESCALATOR")
################################################################################
    ...
    def test_elevators(self):
        ...
        for i in range(len(json_response)):
            self.assertEqual(json_response[i].get("UnitType"), "ELEVATOR")
################################################################################
